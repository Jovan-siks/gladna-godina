...
@Component({
  ...
  template: `
    <div
      class="block ml-8 rounded-2xl border border-[var(--border)] bg-[var(--card)]/60 backdrop-blur-md shadow-xl overflow-x-auto transition-all"
    >
      <table class="min-w-full text-sm text-[var(--foreground)]">
        ...
        <tbody>
          ...
          >
            ...
            <td class="px-6 py-3 border border-[var(--border)]">
              <button
                class="bg-[var(--destructive)] text-white hover:bg-[var(--destructive)]/90 px-4 py-2 rounded-md text-xs font-medium shadow transition"
              >
                Obriši
              </button>
            </td>
